...
class RoleContext(BaseModel):
    ...
    async def comment(self, comment, use_functions=False, use_cache=True):
        return await self.todo.comment(comment, use_functions=use_functions, use_cache=use_cache)
