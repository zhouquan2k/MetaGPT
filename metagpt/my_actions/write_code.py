...
ACTION_PREFIX_FRONTEND = '''
You are a professional frontend programmer; the main goal is to write elegant, modular, easy to read and maintain code.
you're good at following tech-stack: ES6, Vue.js, Element UI component library. 
'''
...
class WriteCode(Action):
    def __init__(self, name="WriteCode", context: list[Message] = None, llm=None, type=None):
        ...
        self.prefix = ACTION_PREFIX_FRONTEND
