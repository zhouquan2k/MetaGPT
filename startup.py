...
def init_company(investment: float = 3.0, code_review: bool = False, run_tests: bool = False):
...
async def run(name: str, new_artifact: str, company: SoftwareCompany):
    await company.run_project_one_step(name, new_artifact)
